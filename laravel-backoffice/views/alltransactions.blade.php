    ...
    <div class="row">
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption caption-md">
                        <span class="caption-subject font-blue-madison bold uppercase">{{ __('Depósitos') }}</span>
                    </div>
                </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading bg-green-jungle font-white">
                                        <h3 class="panel-title"><i class="fa fa-money"></i>
                                            <b>{{ __("Total Depósitos Aprobados") }}</b>
                                        </h3>
                                    </div>
                                    <div class="panel-body"><h3 class="total-creditapproved pull-right"></h3></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading bg-blue-steel font-white">
                                        <h3 class="panel-title">
                                            <b>{{ __("Cantidad de Depósitos Pendientes") }}</b>
                                        </h3>
                                    </div>
                                    <div class="panel-body"><h3 class="total-creditpending pull-right"></h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered" data-load="true">
                <div class="portlet-title">
                    <div class="caption caption-md">
                        <span class="caption-subject font-blue-madison bold uppercase">{{ __('Transacciones') }}</span>
                    </div>
                    <div class="tools"></div>
                ...
                <div class="portlet-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed table-striped datatable-transactions"
                               data-route="{{ route("realcasino.alltransactionsdata") }}">
                            <thead>
                            <tr class="font flip-content">
                                ...
                                <th class="no-sort" width="8%">{{ __('Usuario') }}</th>
                                <th width="8%">{{ __('Monto') }}</th>
                                <th class="no-sort" width="6%">{{ __('Estado') }}</th>
                                <th class="no-sort" width="8%">{{__('Acciones')}}</th>
                            </tr>
                            </thead>
                            <tbody>
...
@section('scripts')
    ...
    <script>
        $(function () {
            RealCasino.dataTableTransactions();
            RealCasino.transactionDepositModal();
            RealCasino.totalsTransactions();
        });
    </script>
@endsection