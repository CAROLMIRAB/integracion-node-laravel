    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="portlet light">
                ...
                <div class="portlet-body" id="totals" data-route="{{ route("realcasino.profituserscasinototal") }}">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="clearfix">
        ...
        <div class="col-md-12">
            <div class="portlet light bordered" data-load="true">
                <div class="portlet-title">
                    <div class="caption caption-md">
                        <span class="caption-subject font-blue-madison bold uppercase">{{ __('Profit Usuarios') }}</span>
                    </div>
                    <div class="tools"></div>
                ...
                <div class="portlet-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed table-striped datatable-profit"
                               data-route="{{ route("realcasino.profituserscasino") }}">
                            <thead>
                            <tr class="font flip-content">
                                <th width="25%">{{ __('Usuario') }}</th>
                                <th class="no-sort" width="25%">{{ __('Depositado') }}</th>
                                <th class="no-sort" width="25%">{{ __('Retirado') }}</th>
                                <th width="25%">{{ __('Profit') }}</th>
                            </tr>
                            </thead>
                            <tbody>
...
@section('scripts')
    ...
    <script>
        $(function () {
            RealCasino.dataTableProfitUsersCasino();
        });
    </script>
@endsection