                            ...
                            <div class="pull-right">
                                <div class="form-group">
                                    <label class="search-label"
                                           for="casino">{{ __('Casino') }}: </label>
                                    <select class="form-control" id="casino-search" name="casino-search"
                                            data-route="{{ route('realcasino.searchcasino') }}">
                                    </select>
                                </div>
